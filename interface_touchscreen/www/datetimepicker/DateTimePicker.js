...
;(function ( $, window, document, undefined ) {
		...
		var defaults = {
			...
			titleContentTime: "Horario riego",
			titleContentDateTime: "Set Date & Time",
			titleContentMin: "Horario riego",
		...
		DateTimePicker.prototype = {
			...
			init: function () 
			{
				...
				dtPickerObj._setMinFormatArray(); // Set DateTimeFormatArray
			...
			_setMinFormatArray: function()
			{
				var dtPickerObj = this;
			
				dtPickerObj.dataObject.sArrInputMinFormats = new Array();
				var sTime = "";

				//  "HH:mm"
				sTime = "mm";
				dtPickerObj.dataObject.sArrInputMinFormats.push(sTime);
			},
			...
			_setOutput: function()
			{
				...
				else if(dtPickerObj._compare(dtPickerObj.settings.mode, "time_dur"))
				{
					if(dtPickerObj._compare(dtPickerObj.dataObject.sTimeFormat, dtPickerObj.dataObject.sArrInputMinFormats[0]))
					{
						var sMeridiem = "";
						if(iHour > 12)
						{
